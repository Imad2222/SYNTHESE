...
function EditProduct  () {
        ...
        axios.get(`/api/edit-product/${id}`,{
            ...
            else if(res.data.status===404)
            {
                Swal.fire({
                    ...
                    navigate('/admin/view-product'); // Navigation après l'alerte
                });
    ...
    const editProduct = (e) => {
        ...
        //form data object to send file and other data
            ...
            {activeTab === "otherdetails" && (
                                    <div className="row">
                                                  ...
                                                  <div className="col-md-4 form-group mb-3">
                                                          ...
                                                          <input type="checkbox" name="featured" onChange={handleCheckout} defaultChecked={allcheckbox.featured === 1 ? true : false || ''} className="w-50 h-50"/>
                                                  </div>
  
                                                  <div className="col-md-4 form-group mb-3">
                                                          <label >Popular (checked=shown) </label>
                                                          <input type="checkbox" name="popular" onChange={handleCheckout} defaultChecked={allcheckbox.popular === 1 ? true : false || ''} className="w-50 h-50"/>
                                                  </div>
  
                                                  <div className="col-md-4 form-group mb-3">
                                                          <label >Status (checked=Hidden) </label>
                                                          <input type="checkbox" name="status" onChange={handleCheckout} defaultChecked={allcheckbox.status === 1 ? true : false || ''} className="w-50 h-50"/>
                                                  </div>
